...
description: Compatibility entrypoint for GridLatch's portable ssh-cluster-ops Agent Skill. Use for bounded, policy-controlled SSH cluster audits, reviewed Git diffs, and managed tmux sessions when an existing Codex installation still uses the legacy skill name.
license: Apache-2.0
metadata:
  author: xin1u
  version: "0.3.0"
...
# GridLatch Legacy Codex Adapter
